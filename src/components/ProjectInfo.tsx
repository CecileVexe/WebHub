...
const ProjectInfo: React.FC<ProjectInfoProps> = ({ project, onClose }) => {
  return (
    <aside className="left-sidebar" role="complementary" aria-labelledby="sidebar-title">
      {/* Sidebar Header with Close Button */}
      <div className="sidebar-header">
        <h2 id="sidebar-title" className="sidebar-main-title">Détails du projet</h2>
        <button 
          type="button"
          onClick={onClose} 
          className="sidebar-close-button" 
          aria-label="Masquer le panneau des détails"
        >
      ...
      {project.tags && project.tags.length > 0 && (
        <div className="sidebar-section">
          ...
          <ul className="tags-container" role="list" aria-label="Étiquettes du projet">
