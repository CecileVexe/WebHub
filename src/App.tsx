...
const projects : Project[] = [
  {
    ...
    description: "A modern online shopping experience with seamless checkout and product browsing.",
    category: "E-Commerce",
  ...
  },
  {
    ...
    description: "Clean and minimalist portfolio showcasing creative work and professional experience.",
    category: "Portfolio",
  ...
  },
  {
    ...
    description: "Connect with friends and share moments through an engaging social platform.",
    category: "Social",
  ...
  },
  {
    id: 5,
    title: "Blog Platform",
    description: "Content management system for writers with markdown support and SEO optimization.",
    category: "Content",
  ...
  },
  {
    ...
    description: "Streamlined reservation and scheduling system for service-based businesses.",
    category: "Business",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl p-8 shadow-xl text-white relative overflow-hidden group hover:scale-105 transition-transform">
              ...
              <div className="relative z-10">
                ...
                <div>{projects.length} Active</div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              <div className="flex items-center justify-center gap-2 mb-4">
                <div className="w-8 h-8 bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 rounded-lg"></div>
                <span className="bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 bg-clip-text text-transparent">
                  Creative Projects
                </span>
              </div>
              <p className="text-gray-600">
                © 2025 Creative Projects. Crafted with passion.
              </p>
            </div>
          </div>
        </footer>
